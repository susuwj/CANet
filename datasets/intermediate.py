...
class INDataset(Dataset):
    def __init__(self, root_dir, list_file, n_views, **kwargs):
        ...
        self.depth_interval = kwargs.get("depth_interval", "1.06")
    ...
    def read_cam_file(self, filename):
        ...
        if self.cam_mode == 'short_range':
            depth_max = depth_min + self.total_depths * depth_interval * self.depth_interval
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            if self.cam_mode == 'short_range':
                ...
                proj_mat_filename = os.path.join(self.root_dir, scan, f'cams_short/{vid:08d}_cam.txt')
