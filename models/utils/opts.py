...
def get_opts():
    ...
    parser.add_argument('--which_dataset', default='dtu', choices=['dtu', 'tnt', 'blendedmvs', 'eth', 'intermediate', 'advanced'], help='which dataset for using')

    parser.add_argument('--n_views', type=int, default=5, help='num of view')
    parser.add_argument('--levels', type=int, default=5, help='num of stages')
    parser.add_argument('--hypo_plane_num_stages', type=str, default="16,8,4,4,4", help='num of hypothesis planes for each stage')
    parser.add_argument('--depth_interval_ratio_stages', type=str, default="0.5,0.5,0.5,0.5,1", help='depth intervals for each stage')
    ...
    parser.add_argument('--group_cor_dim_stages', type=str, default="8,8,4,4,4", help='group correlation dim')
    parser.add_argument('--qkv_dim_stages', type=str, default="4,4,4,4,4", help='')
    parser.add_argument('--heads_stages', type=str, default="4,4,4,4,4", help='')
    ...
    # training config
    parser.add_argument('--stage_lw', type=str, default="1,1,1,1,1", help='loss weight for different stages')
    ...
    parser.add_argument('--depth_interval', type=float, default=1.06, help='TNT dataset')
    parser.add_argument('--cam_mode', type=str, default='short_range', choices=['origin', 'short_range'], help='camera parameter strategy for TNT dataset')

    parser.add_argument('--img_wh', type=str, default='')
